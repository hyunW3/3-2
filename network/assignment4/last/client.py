...
def chat_recv(local_socket,private_ip):
	global exit 
	while True:
		if exit == 1:
			break
...
#		print("invalid ID")
	...
	t2 = threading.Thread(target=chat_recv,args=(local_socket,private_ip,))
	t2.deamon = True
	t2.start()
